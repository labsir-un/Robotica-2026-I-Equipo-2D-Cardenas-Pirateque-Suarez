...
│
├── docs/                                  # (a añadir) documentación del laboratorio
│   ├── diagrama_flujo.png
│   ├── plano_planta.pdf
│   ├── cinematica_directa_inversa.md
│   └── conclusiones/
├── resources/graficas/                    # (a añadir) gráficas de calibración/interpolación/senoidal
└── videos/enlaces_videos.md               # (a añadir) enlaces a videos
