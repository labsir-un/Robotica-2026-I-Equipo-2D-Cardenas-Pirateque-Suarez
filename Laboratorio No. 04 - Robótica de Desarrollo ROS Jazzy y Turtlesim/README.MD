...
Ademas del nodo que contiene la logica el diagrama nos muestra el nodo `turtlesim`que es el que proporciona ROS suendo el encargado de:
* Dibuja las tortugas.
...
Además de esto, se creó otro publicador y otro suscriptor para el sistema líder-seguidor.
...
<div align="center">
  ...
  <br>
  <b>Figura 3. Figura de triangulo.</b>
</div>
...
<div align="center">
  ...
  <br>
  <b>Figura 4. Figura de rectangulo.</b>
</div>
...
```
Una vez implementadas todas estas funcionalidades, al presionar la tecla de activación del seguidor (`2`) se puede observar la aparición de una segunda tortuga, la cual sigue la trayectoria de la tortuga principal. Su recorrido se representa con un color ligeramente más gris.
...
para lograr la ejecucion del codigo teniendo en cuuenta que ya se modificaron los archivos corespondientes solo faltaria abrir dos terminales y correr los siguientes codigos
