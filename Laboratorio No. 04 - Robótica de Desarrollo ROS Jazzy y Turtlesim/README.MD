...
D --> E[Iniciar hilo de procesamiento de ROS 2]
E --> F[Entrar al bucle principal]

F --> G[Leer tecla del teclado]

G --> H{¿Qué tecla fue presionada?}

H -->|↑ ↓ ← →| I[Control manual]
I --> J[Publicar velocidad en /turtle1/cmd_vel]
J --> F

H -->|S| K[Dibujar cuadrado]
K --> J

H -->|T| L[Dibujar triángulo]
L --> J

H -->|R| M[Reiniciar tortuga]
M --> F

H -->|P| N[Activar o desactivar lápiz]
N --> F

H -->|A| O[Ejecutar trayectoria automática]
O --> P{¿Cerca del borde?}
P -->|Sí| Q[Girar]
P -->|No| R[Avanzar]
Q --> J
...
H -->|I| S[Cambiar modo de iniciales]
S --> F

H -->|Modo iniciales| T[Dibujar letra D, S, P, F o C]
T --> J
...
H -->|3| W[Eliminar turtle2]
W --> F

H -->|Q| X[Detener movimiento]
X --> J

H -->|Ctrl+C| Y([Finalizar programa])

D --> Z[Temporizador del líder-seguidor]
